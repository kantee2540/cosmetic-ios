...
class CosmeticDeskModel: NSObject, NSCoding {
    ...
    init(desk_id: String, user_id: String, product_id: String, product_name: String, product_description: String, product_price: Int, categories_id: String, categories_name: String, brand_name: String, product_img: String, ingredient: String) {
    ...
    required convenience init(coder aDecoder: NSCoder) {
        ...
        self.init(desk_id: desk_id ?? "", user_id: user_id ?? "", product_id: product_id ?? "", product_name: product_name ?? "", product_description: product_description ?? "", product_price: product_price ?? 0, categories_id: categories_id ?? "", categories_name: categories_name ?? "", brand_name: brand_name ?? "", product_img: product_img ?? "", ingredient: ingredient ?? "")
    }
